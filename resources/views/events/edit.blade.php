                ...
                <form action="{{ route('events.update', $event) }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" step="0.01" name="budget" class="form-control @error('budget') is-invalid @enderror" value="{{ old('budget', $event->budget) }}">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="assigned_to" class="form-select @error('assigned_to') is-invalid @enderror">
                            ...
                            @foreach(\App\Models\User::where('role', 'staff')->get() as $staff)
                                <option value="{{ $staff->id }}" {{ old('assigned_to', $event->assigned_to) == $staff->id ? 'selected' : '' }}>
                                    {{ $staff->name }}
                                </option>
                            @endforeach
                        </select>
